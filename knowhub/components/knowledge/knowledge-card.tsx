...
export function KnowledgeCard({
  ...
  return (
    <Link
      ...
      className="block h-full overflow-hidden rounded-[16px] border border-[#d8e1eb] bg-white text-left shadow-[0_8px_22px_rgba(15,23,42,0.04)] transition-all hover:-translate-y-0.5 hover:border-[#bfd0e2] hover:shadow-[0_12px_26px_rgba(15,23,42,0.07)]"
    >
      <div className="flex min-h-[214px] flex-col px-4 py-4">
        ...
        <div className="mt-auto pt-3 text-[11px] text-[#7b8798]">
          <div className="truncate">DocSpace：{docspaceNames.join("、")}</div>
