import {
  ...
  updateBuild, updateDeploymentStatus, setSessionTitleFromPrompt,
} from "./database";

export const projectRepository = { list: listProjects, create: createProject, get: getProject };
export const sessionRepository = { create: createSession, list: listSessions, get: getSession, setStatus: setSessionStatus, setTranscriptPath: setSessionTranscriptPath, setTitleFromPrompt: setSessionTitleFromPrompt };
