...
export default function ProjectPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const stop = () => { controllerRef.current?.abort(); controllerRef.current = null; setBusy(false); setError("已停止当前任务"); };
